<template>
  <div class="h-screen flex justify-center items-center">
    <div class="p-8 max-w-6xl">
      <h1 class="font-bold dark:text-indigo-200 text-3xl text-center mb-8" style="color:grey">Login</h1>
      <h2 class="font-bold text-2xl text-center dark:text-gray-50 mb-8" style="color:lightgray">Vue3 Todo App</h2>
